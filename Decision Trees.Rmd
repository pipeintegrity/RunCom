...
###Decision Trees
The best way to show the use of decision trees is with an initial simple one.  The following decision tree is based on a dataset of the passengers of the Titanic.  The way to think of these is an upside down tree with root at the top and the leaves at the bottom.  
```{r, echo=FALSE,,message=FALSE}
library(rpart)
library(rattle)
